...
## 二、 使用方法
### 1. 使用说明
先使用 [`fallback` 自动回退](https://wiki.metacubex.one/config/proxy-groups/fallback/)策略优先选择各个优选 IP 来源的第一个节点（质量最高），然后使用 [`load-balance` 负载均衡](https://wiki.metacubex.one/config/proxy-groups/load-balance/)策略供用户选择使用
...
proxy-groups:
  ...
  - {name: 移动优选节点 IPv4, type: load-balance, strategy: consistent-hashing, proxies: [移动优选节点 CMLiu_IPv4, 移动优选节点 VPS789_IPv4, 移动优选节点 CFYes_IPv4, 移动优选节点 WeTest_IPv4], icon: "https://github.com/DustinWin/ruleset_geodata/releases/download/icons/cmcc.png"}
  ...
  - {name: 移动优选节点 IPv6, type: load-balance, strategy: consistent-hashing, proxies: [移动优选节点 CMLiu_IPv6, 移动优选节点 CFYes_IPv6, 移动优选节点 WeTest_IPv6], icon: "https://github.com/DustinWin/ruleset_geodata/releases/download/icons/cmcc.png"}
  ...
  - {name: 联通优选节点 IPv4, type: load-balance, strategy: consistent-hashing, proxies: [联通优选节点 CMLiu_IPv4, 联通优选节点 VPS789_IPv4, 联通优选节点 CFYes_IPv4, 联通优选节点 WeTest_IPv4], icon: "https://github.com/DustinWin/ruleset_geodata/releases/download/icons/cucc.png"}
  ...
  - {name: 联通优选节点 IPv6, type: load-balance, strategy: consistent-hashing, proxies: [联通优选节点 CFYes_IPv6, 联通优选节点 WeTest_IPv6], icon: "https://github.com/DustinWin/ruleset_geodata/releases/download/icons/cucc.png"}
  ...
  - {name: 电信优选节点 IPv4, type: load-balance, strategy: consistent-hashing, proxies: [电信优选节点 CMLiu_IPv4, 电信优选节点 VPS789_IPv4, 电信优选节点 CFYes_IPv4, 电信优选节点 WeTest_IPv4], icon: "https://github.com/DustinWin/ruleset_geodata/releases/download/icons/ctcc.png"}
  ...
  - {name: 电信优选节点 IPv6, type: load-balance, strategy: consistent-hashing, proxies: [电信优选节点 CFYes_IPv6, 电信优选节点 WeTest_IPv6], icon: "https://github.com/DustinWin/ruleset_geodata/releases/download/icons/ctcc.png"}
  ...
  - {name: CF 优选 IP 节点, type: load-balance, strategy: consistent-hashing, proxies: [CF 优选节点 VPS789, CF 优选节点 CFSpeedTest, CF 优选节点 IPDB_IPv4, CF 优选节点 IPDB_IPv6], icon: "https://github.com/DustinWin/ruleset_geodata/releases/download/icons/cfip.png"}
...
### 3. [singr-box 内核](https://github.com/reF1nd/sing-box)
- 注：以下只是节选，请酌情套用
...
```json
{
  ...
  "outbounds": [
    ...
    { "tag": "移动优选节点 IPv4", "type": "loadbalance", "strategy": "consistent-hashing", "outbounds": [ "移动优选节点 CMLiu_IPv4", "移动优选节点 VPS789_IPv4", "移动优选节点 CFYes_IPv4", "移动优选节点 WeTest_IPv4" ] },
    { "tag": "移动优选节点 CMLiu_IPv4", "type": "urltest", "tolerance": 100, "providers": [ "🆓 免费订阅" ], "include": "(?i)(CMCC-IPv4_CMLiu)", "fallback": { "enabled": true, "max_delay": "400ms" } },
    { "tag": "移动优选节点 VPS789_IPv4", "type": "urltest", "tolerance": 100, "providers": [ "🆓 免费订阅" ], "include": "(?i)(CMCC-IPv4_VPS789)", "fallback": { "enabled": true, "max_delay": "400ms" } },
    { "tag": "移动优选节点 CFYes_IPv4", "type": "urltest", "tolerance": 100, "providers": [ "🆓 免费订阅" ], "include": "(?i)(CMCC-IPv4_CFYes)", "fallback": { "enabled": true, "max_delay": "400ms" } },
    { "tag": "移动优选节点 WeTest_IPv4", "type": "urltest", "tolerance": 100, "providers": [ "🆓 免费订阅" ], "include": "(?i)(CMCC-IPv4_WeTest)", "fallback": { "enabled": true, "max_delay": "400ms" } },
    { "tag": "移动优选节点 IPv6", "type": "loadbalance", "strategy": "consistent-hashing", "outbounds": [ "移动优选节点 CMLiu_IPv6", "移动优选节点 CFYes_IPv6", "移动优选节点 WeTest_IPv6" ] },
    { "tag": "移动优选节点 CMLiu_IPv6", "type": "urltest", "tolerance": 100, "providers": [ "🆓 免费订阅" ], "include": "(?i)(CMCC-IPv6_CMLiu)", "fallback": { "enabled": true, "max_delay": "400ms" } },
    { "tag": "移动优选节点 CFYes_IPv6", "type": "urltest", "tolerance": 100, "providers": [ "🆓 免费订阅" ], "include": "(?i)(CMCC-IPv6_CFYes)", "fallback": { "enabled": true, "max_delay": "400ms" } },
    { "tag": "移动优选节点 WeTest_IPv6", "type": "urltest", "tolerance": 100, "providers": [ "🆓 免费订阅" ], "include": "(?i)(CMCC-IPv6_WeTest)", "fallback": { "enabled": true, "max_delay": "400ms" } },
    { "tag": "联通优选节点 IPv4", "type": "loadbalance", "strategy": "consistent-hashing", "outbounds": [ "联通优选节点 CMLiu_IPv4", "联通优选节点 VPS789_IPv4", "联通优选节点 CFYes_IPv4", "联通优选节点 WeTest_IPv4" ] },
    { "tag": "联通优选节点 CMLiu_IPv4", "type": "urltest", "tolerance": 100, "providers": [ "🆓 免费订阅" ], "include": "(?i)(CUCC-IPv4_CMLiu)", "fallback": { "enabled": true, "max_delay": "400ms" } },
    { "tag": "联通优选节点 VPS789_IPv4", "type": "urltest", "tolerance": 100, "providers": [ "🆓 免费订阅" ], "include": "(?i)(CUCC-IPv4_VPS789)", "fallback": { "enabled": true, "max_delay": "400ms" } },
    { "tag": "联通优选节点 CFYes_IPv4", "type": "urltest", "tolerance": 100, "providers": [ "🆓 免费订阅" ], "include": "(?i)(CUCC-IPv4_CFYes)", "fallback": { "enabled": true, "max_delay": "400ms" } },
    { "tag": "联通优选节点 WeTest_IPv4", "type": "urltest", "tolerance": 100, "providers": [ "🆓 免费订阅" ], "include": "(?i)(CUCC-IPv4_WeTest)", "fallback": { "enabled": true, "max_delay": "400ms" } },
    { "tag": "联通优选节点 IPv6", "type": "loadbalance", "strategy": "consistent-hashing", "outbounds": [ "联通优选节点 CFYes_IPv6", "联通优选节点 WeTest_IPv6" ] },
    { "tag": "联通优选节点 CFYes_IPv6", "type": "urltest", "tolerance": 100, "providers": [ "🆓 免费订阅" ], "include": "(?i)(CUCC-IPv6_CFYes)", "fallback": { "enabled": true, "max_delay": "400ms" } },
    { "tag": "联通优选节点 WeTest_IPv6", "type": "urltest", "tolerance": 100, "providers": [ "🆓 免费订阅" ], "include": "(?i)(CUCC-IPv6_WeTest)", "fallback": { "enabled": true, "max_delay": "400ms" } },
    { "tag": "电信优选节点 IPv4", "type": "loadbalance", "strategy": "consistent-hashing", "outbounds": [ "电信优选节点 CMLiu_IPv4", "电信优选节点 VPS789_IPv4", "电信优选节点 CFYes_IPv4", "电信优选节点 WeTest_IPv4" ] },
    { "tag": "电信优选节点 CMLiu_IPv4", "type": "urltest", "tolerance": 100, "providers": [ "🆓 免费订阅" ], "include": "(?i)(CTCC-IPv4_CMLiu)", "fallback": { "enabled": true, "max_delay": "400ms" } },
    { "tag": "电信优选节点 VPS789_IPv4", "type": "urltest", "tolerance": 100, "providers": [ "🆓 免费订阅" ], "include": "(?i)(CTCC-IPv4_VPS789)", "fallback": { "enabled": true, "max_delay": "400ms" } },
    { "tag": "电信优选节点 CFYes_IPv4", "type": "urltest", "tolerance": 100, "providers": [ "🆓 免费订阅" ], "include": "(?i)(CTCC-IPv4_CFYes)", "fallback": { "enabled": true, "max_delay": "400ms" } },
    { "tag": "电信优选节点 WeTest_IPv4", "type": "urltest", "tolerance": 100, "providers": [ "🆓 免费订阅" ], "include": "(?i)(CTCC-IPv4_WeTest)", "fallback": { "enabled": true, "max_delay": "400ms" } },
    { "tag": "电信优选节点 IPv6", "type": "loadbalance", "strategy": "consistent-hashing", "outbounds": [ "电信优选节点 CFYes_IPv6", "电信优选节点 WeTest_IPv6" ] },
    { "tag": "电信优选节点 CFYes_IPv6", "type": "urltest", "tolerance": 100, "providers": [ "🆓 免费订阅" ], "include": "(?i)(CTCC-IPv6_CFYes)", "fallback": { "enabled": true, "max_delay": "400ms" } },
    { "tag": "电信优选节点 WeTest_IPv6", "type": "urltest", "tolerance": 100, "providers": [ "🆓 免费订阅" ], "include": "(?i)(CTCC-IPv6_WeTest)", "fallback": { "enabled": true, "max_delay": "400ms" } },
    { "tag": "CF 优选 IP 节点", "type": "loadbalance", "strategy": "consistent-hashing", "outbounds": [ "CF 优选节点 VPS789", "CF 优选节点 CFSpeedTest", "CF 优选节点 IPDB_IPv4", "CF 优选节点 IPDB_IPv6" ] },
    { "tag": "CF 优选节点 VPS789", "type": "urltest", "tolerance": 100, "providers": [ "🆓 免费订阅" ], "include": "(?i)(CF-IPv4_VPS789)", "fallback": { "enabled": true, "max_delay": "400ms" } },
    { "tag": "CF 优选节点 CFSpeedTest", "type": "urltest", "tolerance": 100, "providers": [ "🆓 免费订阅" ], "include": "(?i)(CF-IPv4_CFSpeedTest)", "fallback": { "enabled": true, "max_delay": "400ms" } },
    { "tag": "CF 优选节点 IPDB_IPv4", "type": "urltest", "tolerance": 100, "providers": [ "🆓 免费订阅" ], "include": "(?i)(CF-IPv4_IPDB)", "fallback": { "enabled": true, "max_delay": "400ms" } },
    { "tag": "CF 优选节点 IPDB_IPv6", "type": "urltest", "tolerance": 100, "providers": [ "🆓 免费订阅" ], "include": "(?i)(CF-IPv6_IPDB)", "fallback": { "enabled": true, "max_delay": "400ms" } },
